...
fun Context.showToast(msgId: Int, duration: Int = Toast.LENGTH_SHORT) {
...
fun Fragment.showToast(msgId: Int, duration: Int = Toast.LENGTH_SHORT) {
    activity?.let {
        Toast.makeText(it, msgId, duration).show()
    }
}
